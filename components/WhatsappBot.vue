<template>
  <a href="https://wa.me/+5715110567" target="_blank">
  <div class="wp-body speech-wrapper shadow-[0px_0px_10px_2px_rgba(34,_197,_94,_0.5)] my-20 rounded-2xl">
    <div class="flex flex-col md:flex-row items-center md:gap-3">
      ...
      <div class="w-full md:w-8/12 md:text-right mt-5 md:mt-0 text-center">
        ...
        <p class="text-3xl sm:text-4xl text-[#25d366] font-oswald font-medium uppercase">Escríbenos por WhatsApp y hazlo de manera rápida y sencilla</p>
        <div class="flex gap-2 items-center justify-center md:justify-end mt-5">
          <p class="text-xl sm:text-3xl font-semibold">¡Haz que tu voz cuente!</p><UIcon name="i-heroicons-arrow-right-16-solid" class="text-2xl"/> <UIcon name="i-fa6-brands-whatsapp" class="text-3xl sm:text-5xl text-[#25d366]" />
        </div>
      </div>
    </div>
