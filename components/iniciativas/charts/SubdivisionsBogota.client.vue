...
const { data, error, status, refresh } = await useAPI('/initiatives/stats/chart/count-by-subdivision/2',{
  onResponse({ request, response, options }) {
    ...
    chartOption.value = {
      ...
      title: {
        text: 'Iniciativas por localidad en Bogotá',
      },
      tooltip: {
        trigger: 'item',
        showDelay: 0,
        ...
        formatter: function (params) {
          return `<div><p><b>${params.name}</b></p><p>${params.value} iniciativas</p><div>`;
        },
        textStyle: {
          fontFamily: 'Inter',
          color: 'white',
