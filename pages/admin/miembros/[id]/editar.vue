...
<template>
  <div>
    ...
    <p>Puede editar un miembro. Debe completar los campos que son requeridos (<span class="text-red">*</span>) y, de querer, cambiar la foto de perfil por una nueva (tiene que ser cuadrada y se acepta JPG o PNG. Recomendamos que sea JPG minimamente de 500x500 px).</p>
    <br>    
