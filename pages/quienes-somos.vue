          ...
          <template #que-hemos-logrado>
            <div class="text-base text-white space-y-3 text-justify my-3 px-6">
              <ul class="list-disc space-y-3">
                ...
                <li>Hemos co-creado 2 agendas ciudadanas (una para <ULink to="https://drive.google.com/file/d/1llrOZtZeeN6PQo9QOayvNtVniI2eYLb9/view" target="blank" class="text-mindaro">Cali <UIcon name="i-heroicons-arrow-top-right-on-square" /></ULink> y otra para <ULink to="https://drive.google.com/file/d/1llrOZtZeeN6PQo9QOayvNtVniI2eYLb9/view" target="blank" class="text-mindaro">Bogotá <UIcon name="i-heroicons-arrow-top-right-on-square" /></ULink>) donde se reflejan los sentires de las juventudes, sus problemáticas, exigencias y propuestas.</li>
